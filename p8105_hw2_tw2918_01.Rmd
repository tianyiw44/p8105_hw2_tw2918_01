...
* There were `r nrow(long_biomaker_df)` participants in this dataset
* The average `baseline` time in years when biomaker amyloid is measured is `r mean(long_biomaker_df$baseline, na.rm=TRUE)`
* The average 2nd time in year when biomaker amyloid is measured is `r mean(long_biomaker_df$time_2, na.rm=TRUE)`, 4th time is `r mean(long_biomaker_df$time_4, na.rm=TRUE)`, 6th time is `r mean(long_biomaker_df$time_6, na.rm=TRUE)` and 8th time is `r mean(long_biomaker_df$time_8, na.rm=TRUE)`
